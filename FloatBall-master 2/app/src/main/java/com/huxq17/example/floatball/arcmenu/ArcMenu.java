...
package com.huxq17.example.floatball.arcmenu;
...
import com.huxq17.example.floatball.R;
...
public class ArcMenu extends RelativeLayout {
    ...
    public void setRadius(int radius) {
        mArcLayout.setChildSize(radius);
    }

    public void setDegree(int fromDegree,int toDegree) {
